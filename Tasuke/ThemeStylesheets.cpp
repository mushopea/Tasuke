...
QStringList ThemeStylesheets::TASKENTRY_NORMAL_STYLES = QStringList() << "QLabel#background{border-radius: 12px; background-color: rgb(203, 202, 202);}" // theme 1: default
...
QStringList ThemeStylesheets::TASKENTRY_SELECT_STYLES = QStringList() << "QLabel#background{border-radius: 12px; background-color: rgb(176, 175, 175);}" // theme 1: default
...
QStringList ThemeStylesheets::INPUTWINDOW_STYLES = QStringList() << "QLabel#bg{border-radius: 8px; background-color: white;}" // theme 1: default
...
QStringList ThemeStylesheets::SUBHEADING_STYLES = QStringList() << "QLabel{\n" // theme 1: default
																	"color: rgb(99, 99, 99);\n"
																	"}\n"
																	"background: transparent;"
